        ...
        {active && typeof active === "object" ? (
          <div className="fixed inset-0 grid place-items-center z-[100]">
            <motion.button
              ...
              className="flex absolute top-8 right-4 items-center justify-center rounded-full h-8 w-8 shadow-lg z-[110]"
            ...
            <motion.div
              ...
              ref={ref}
              className="relative w-full max-w-[50rem] h-full md:h-fit md:max-h-[90%] flex flex-col bg-white dark:bg-gray-900 sm:rounded-3xl overflow-hidden"
            >
                  ...
                  <div className="flex-1">
                    <div className="flex flex-col items-start mb-3">
                      ...
                      <motion.p
                        ...
                        className="text-neutral-600 dark:text-neutral-400 text-base font-medium"
                      >
                        {active.type}
                      </motion.p>
                    </div>
              ...
              <div className="flex flex-col w-full">
                ...
                <div className="flex items-baseline gap-2 mb-3">
                  <motion.h3
                    ...
                    className="font-bold text-neutral-800 dark:text-neutral-200 text-xl mt-2 leading-tight"
                  >
                    {project.name}
                  </motion.h3>
                  <motion.p
                    layoutId={`description-${project.type}-${id}`}
                    className="text-neutral-600 dark:text-neutral-400 text-md font-medium"
                  >
                    - {project.type}
                  </motion.p>
                </div>
